                        ...
                        <div class="myform form">
                            ...
                            <div class="form-group">
                                <label class="control-label">
                                    <h4>Chose another name</h4>
                                </label>
                                <input type="text" name="name" id="name" class="form-control" value="<?=$this->album->name?>" placehold="Name" required>
                            </div>
                            <?= FH::displayErrors($this->displayErrors)?>
                            <div class="footer center">
                                <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm" id="save">Submit</button>
                            </div>
                            <div class="col-md-12 ">
                                <div class="login-or">
                                    <hr class="hr-or">
                            ...
                            <div class="col-md-12 mb-3 center">
                                <a href="<?=PROOT?>album" class="google btn mybtn" id="cancel">
                                    Cancel
                                </a>
                            </div>
                        </div>
