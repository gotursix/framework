  ...
  <div class="container">
    <div class="content">
      <div class="row">
        <div id="image-grid" class="container-fluid ">
          <div class="whitebg center formerfix">
            <h1 class="center lg-bg col-md-5 mx-auto noselect">Deleted  videos</h1>
            <hr>
            <a href="<?=PROOT?>upload/modify" class="btn btn-danger">
              Delete all videos
            </a>
  ...
  <div class="container">
    <div class="content">
      <div class="row">
        <div id="image-grid" class="container-fluid ">
          <div class="whitebg center formerfix">
            <h1 class="center lg-bg col-md-5 mx-auto noselect">Deleted  audios</h1>
            <hr>
            <a href="<?=PROOT?>upload/modify" class="btn btn-danger" >
  ...
  <div class="container">
    <div class="content">
      <div class="row">
        <div id="image-grid" class="container-fluid ">
          <div class="whitebg center formerfix">
            <h1 class="center lg-bg col-md-5 mx-auto noselect">Deleted  documents</h1>
            <hr>
            <a href="<?=PROOT?>upload/modify" class="btn btn-danger" >
