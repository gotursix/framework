            ...
            <div class="row">
                <div id="image-grid" class="container-fluid ">
                    <div class="whitebg center ">
                        ...
                        <hr>
                        <a href="<?=PROOT?>upload/deleteall/1" class="btn btn-danger" onclick="if(!confirm('Are you sure ?')){return false;}" id="delete-all">
                            Delete all images
                        </a>
                        <hr>
                        ...
                        <div class="row">
                            <div id="image-grid" class="container-fluid ">
                                <div class="whitebg center <?php if(FH::number($this->upload , 1)>0):  ?>formerfix<?php endif;?>">
                                    ...
                                    <hr>
                                    <a href="<?=PROOT?>upload/deleteall/2" class="btn btn-danger" onclick="if(!confirm('Are you sure ?')){return false;}" id="delete-all">
                                        Delete all videos
                                    </a>
                                    <hr>
                                    <div class="row">
                        ...
                        <div class="row">
                            <div id="image-grid" class="container-fluid ">
                                <div class="whitebg center <?php if(FH::number($this->upload , 1) + FH::number($this->upload , 2)>0):  ?>formerfix<?php endif;?>">
                                    <h1 class="center lg-bg col-md-5 mx-auto " id="delete-all">Delete all audios</h1>
                                    <hr>
                        ...
                        <div class="row">
                            <div id="image-grid" class="container-fluid ">
                                <div class="whitebg center <?php if(FH::number($this->upload , 3)+FH::number($this->upload , 1) + FH::number($this->upload , 2)>0):  ?>formerfix<?php endif;?>">
                                    ...
                                    <hr>
                                    <a href="<?=PROOT?>upload/deleteall/4" class="btn btn-danger" onclick="if(!confirm('Are you sure ?')){return false;}" id="delete-all">
                            ...
                            <div class="container">
                                <div class="content">
                                    <div class="row">
                                        <div id="image-grid" class="container-fluid ">
                                            <div class="whitebg center <?php if(FH::number($this->upload , 1)>0):  ?>formerfix<?php endif;?>">
                                                <h1 class="center lg-bg col-md-5 mx-auto " id="delete">Delete files</h1>
                                                <hr>
                                                <a href="<?=PROOT?>settings/restore" class="btn-reg btn-primary" id="restore">
                                                    Restore files
                                                </a>
                                                <hr><br>
